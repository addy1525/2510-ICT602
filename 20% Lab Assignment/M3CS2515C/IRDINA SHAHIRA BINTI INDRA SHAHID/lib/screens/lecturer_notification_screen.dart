...
class LecturerNotificationScreen extends StatefulWidget {
  ...
  LecturerNotificationScreen({required this.user});

  @override
  _LecturerNotificationScreenState createState() => _LecturerNotificationScreenState();
}
...
class _LecturerNotificationScreenState extends State<LecturerNotificationScreen> {
  ...
  IconData _getNotificationIcon(String type) {
    switch (type) {
      ...
      case 'peer_assessment': return Icons.group;
  ...
  Color _getNotificationColor(String type) {
    switch (type) {
      ...
      case 'peer_assessment': return Colors.purple;
